...
- [ ] T036 Run `npm run check` and `npm run test:browser` green, plus the manual keyboard-only and 320 px review the constitution requires for the new operator screen (depends on T035)
