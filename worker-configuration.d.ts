/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 041b1e399003d7ef24bab6137aad7106)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 
interface __BaseEnv_Env {
	...
	RESERVATION_DAYS: DurableObjectNamespace<import("./src/worker").ReservationDay>;
	INSTALLATION_CONFIG: DurableObjectNamespace<import("./src/worker").InstallationConfig>;
	ADAPTER_DELIVERY: DurableObjectNamespace<import("./src/worker").AdapterDelivery>;
	CALENDAR_ADAPTER: DurableObjectNamespace<import("./src/worker").CalendarAdapter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ReservationDay" | "InstallationConfig" | "AdapterDelivery" | "CalendarAdapter";
	}
